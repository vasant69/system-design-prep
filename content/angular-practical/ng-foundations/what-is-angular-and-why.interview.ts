...
const questions: InterviewQuestion[] = [
  ...
  },
  {
    ...
    detailedAnswer:
      "Angular ka value tab dikhta hai jab app me heavy interactivity, bahut sare forms, shared state, role-based screens, aur lambi maintenance life ho. 4 static pages + ek contact form me se kuch bhi nahi. Angular chunne ka cost: bada JS bundle (slow first paint, mobile pe khaas kar), SEO ke liye extra SSR/prerender setup, aur ek build pipeline jise koi maintain karein. Behtar: static-first tooling, contact form ek serverless function ya form service se. Agar client bole 'aage ye ek pura portal banega with login and dashboards', tab conversation badal jaati hai — future scope genuine ho to SPA framework justify ho sakta hai.",
